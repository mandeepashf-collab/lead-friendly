  ...
  return (
    <div className="relative">
      <button onClick={() => setOpen(!open)}
        className={cn("w-9 h-9 rounded-full flex items-center justify-center transition-colors", open ? "bg-emerald-600 text-white" : "bg-zinc-800 hover:bg-zinc-700 text-zinc-400")}>
